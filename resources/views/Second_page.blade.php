                            ...
                            <div class="col-8">
                                <img src="{{asset('assets/login_img.png')}}" alt="image">
                                   ...
                                   <div class="col-4">
                                    ...
                                    <h2 class="sub_head mb-4"> <strong>We Need To Verify Your Identity</strong></h2>
                                    </div>
                                    <!-- Email input -->
                                        <div class="px-5 mb-3">
                                   <input type="number" class="login_password"  autocomplete="off" placeholder="+1 *******20">
                                        </div>
                                      <!-- Checkbox -->
                                    <div class="px-5">
                                    ...
                                    <a href="{{asset('Third_page')}}"><button type="button" class="button1 btn btn-primary">SEND TEXT</button></a>
                                       </div>
                                    </div>
                                </div>
                            </div>
